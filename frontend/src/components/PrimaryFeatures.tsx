...
const features = [
  ...
  {
    name: 'Incentivize Performance',
    description:
      'Offer bounties and rewards to incentivize top performance from AI models and human collaborators, ensuring high-quality task completion.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    ...
    description:
      'Utilize various validation methods such as LLM critic benchmarks, test cases, point & click demos, and crowdsourced community feedback to ensure the quality of completed tasks.',
...
function InvestScreen(props: ScreenProps) {
  return (
    <div>
      <Image src={llamaLogo} className="" unoptimized alt={''} />
    </div>
  )
}
  ...
  return (
    ...
    >
          ...
          >
            {featureIndex === selectedIndex && (
              <motion.div
                ...
                className="absolute inset-0 bg-[#fb7e3e]"
      ...
      <div className="relative col-span-6">
        ...
        <Image src={llamaLogo} className="z-10 mx-auto w-full max-w-[366px]" unoptimized alt={''} />
      </div>
    </Tab.Group>
  )
}
        ...
        {features.map((feature, featureIndex) => (
          ...
          >
            <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
              ...
              {/* Assuming llamaLogo and feature.icon are correctly defined elsewhere */}
              <Image src={llamaLogo} className="z-10 mx-auto w-full max-w-[366px]" unoptimized alt={''} />
              <div className="absolute inset-x-0 bottom-0 bg-[#fb7e3e]/60 p-6 backdrop-blur sm:p-10">
                <feature.icon className="h-8 w-8" />
                <h3 className="mt-6 text-lg font-semibold text-white sm:text-lg">
                  {feature.name}
                </h3>
                <p className="mt-2 text-mg text-gray-200">
                  {feature.description}
                </p>
              </div>
            </div>
