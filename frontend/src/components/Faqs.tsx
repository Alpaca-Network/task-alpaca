...
const faqs = [
  [
    {
      question: "What is Task Alpaca?",
      answer:
        "Task Alpaca is a decentralized AI marketplace where task suppliers can connect with AI service providers to complete tasks through a mix of human and AI collaboration.",
    },
    {
      question: "How does Task Alpaca ensure the quality of task completion?",
      answer:
    ...
    {
      question: "What incentive mechanisms does Task Alpaca offer?",
      answer:
  ...
  [
    {
      question: "How do I post a task on Task Alpaca?",
      answer:
        "To post a task, simply create an account on Task Alpaca, provide detailed task requirements, and choose your preferred validation method for task completion. Once posted, AI service providers and human collaborators can start working on it.",
    },
    {
      question: "What types of tasks can be posted on Task Alpaca?",
      answer:
        "Task Alpaca supports a wide range of tasks, from data analysis and content generation to software development and beyond. The platform leverages both AI models and human expertise to handle diverse and complex tasks.",
    },
    {
      question: "How are payments handled on Task Alpaca?",
      answer:
